...
FilenameL1L1      = 'BoundsL1L1.dat';
FilenameL1L1Sharp = 'BoundsL1L1Sharp.dat';
...
fid6   = fopen(FilenameL1L1,      'w');
fid7   = fopen(FilenameL1L1Sharp, 'w');
...
for ind_beta = 1 : num_betas
    ...
    fprintf(fid6,   '%3.3f %d\n', log10(beta_vec(ind_beta))+2, ceil(bound_L1(ind_beta)));
    fprintf(fid7,   '%3.3f %d\n', log10(beta_vec(ind_beta))+2, ceil(bound_L1_sharper(ind_beta)));
end
