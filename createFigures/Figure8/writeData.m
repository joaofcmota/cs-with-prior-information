...
%%
% =========================================================================
% Experiments L1-L1 for varying c: file ExperimentsL1L1c.m
...
for ind_c = 1 : num_c
    fprintf(fid1,   '%2.1f %d\n', c_vec(ind_c)-1, min_measurementsL1(ind_c));
    fprintf(fid2,   '%2.1f %d\n', c_vec(ind_c)-1, ceil(bound_L1(ind_c)));
    fprintf(fid3,   '%2.1f %d\n', c_vec(ind_c)-1, ceil(bound_L1_sharper(ind_c)));
    fprintf(fid4,   '%2.1f %d\n', c_vec(ind_c)-1, min_measurementsL2(ind_c));
    fprintf(fid5,   '%2.1f %d\n', c_vec(ind_c)-1, ceil(bound_L2(ind_c)));
    fprintf(fid6,   '%2.1f %d\n', c_vec(ind_c)-1, ceil(bound_L2_sharper(ind_c)));
end
