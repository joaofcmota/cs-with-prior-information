...
% information is improved by an additive factor, i.e., 
% w <- w + sign(w)*c, for different values of c.
%
% WARNING: beta = 1 for L1-L1 but varies for L1-L2
...
for ind_c = 1 : num_c
    ...
    [bound_L1_sharper(ind_c), t_dummy] = sharperL1L1Bound(x, w, 1);
